...
// ---------------------------------------------------------------------------
  ...
  mi_decl_new(n) inline void* operator new(std::size_t n) noexcept(false) { return mi_new(n); }
  mi_decl_new(n) inline void* operator new[](std::size_t n) noexcept(false) { return mi_new(n); }

  mi_decl_new_nothrow(n) inline void* operator new  (std::size_t n, const std::nothrow_t& tag) noexcept { (void)(tag); return mi_new_nothrow(n); }
  mi_decl_new_nothrow(n) inline void* operator new[](std::size_t n, const std::nothrow_t& tag) noexcept { (void)(tag); return mi_new_nothrow(n); }
