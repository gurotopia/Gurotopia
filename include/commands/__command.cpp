...
std::unordered_map<std::string_view, std::function<void(ENetEvent&, const std::string_view)>> cmd_pool
{
    ...
    {
        packet::action(*event.peer, "log", "msg|>> Commands: /find /warp {world} /info {player} /sb {msg} /who /me {msg} /weather {id} /wave /dance /love /sleep /facepalm /fp /smh /yes /no /omg /idk /shrug /furious /rolleyes /foldarms /stubborn /fold /dab /sassy /dance2 /march /grumpy /shy");
    }},
    {"find", &find},
    {"warp", &warp},
    {"info", &info},
